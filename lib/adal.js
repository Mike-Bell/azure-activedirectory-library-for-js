 ...
 * @property {cleanupIframes}  Specifies whether or not to delete iframes after they have finished fetching a token (default:false)
 */
...
AuthenticationContext.prototype.registerCallback = function (expectedState, resource, callback) {
    ...
    if (!window.callBackMappedToRenewStates[expectedState]) {
        window.callBackMappedToRenewStates[expectedState] = function (message, token) {
			if (self.config.cleanupIframes){
                var frameHandle = self._getAdalFrameHandle('adalRenewFrame' + resource);
                if (frameHandle){
...
AuthenticationContext.prototype._getAdalFrameHandle = function (iframeId){
...
AuthenticationContext.prototype._addAdalFrame = function (iframeId) {
    ...
    var adalFrame = this._getAdalFrameHandle(iframeId);
